...
{
    if(pObj->categoria == FLOAT_STR || pObj->categoria == INT_STR || pObj->categoria == ID){
...
{
    CelObjeto *corre = iniLista->prox;
    if(tipoLista == ITENS)
	printf("==========================\n  Fila de itens lexicos\n  item (categoria)\n. . . . . . . . . . . . .\n");
    else if(tipoLista == VALORES)
	printf("==========================\n  Fila de itens valores\n  valor (categoria)\n. . . . . . . . . . . . .\n");
    while(corre != NULL){
	mostreObjeto(corre, tipoLista);
	corre = corre->prox;
    }
    printf("\n");
}    
