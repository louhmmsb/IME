...
(define (desugar [as : ExprS]) : ExprC
  (type-case ExprS as
    ...
    [letrecS (n a b) (letC n (desugar a) (seqC (setC n (desugar a)) (desugar b)))]
    ))
...
(define (interp [a : ExprC] [env : Env]) : Value
  (type-case ExprC a
    ...
    [let*C  (n1 a1 n2 a2 body)
            (let ([new-env (extend-env (bind n1 (box (interp a1 env))) env)])
              (let ([new2-env (extend-env (bind n2 (box (interp a2 new-env))) new-env)])
